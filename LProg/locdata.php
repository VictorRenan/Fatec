 ...
 switch ($passo)
{
	case '0':
	{ ?>
<form method="POST" action="armaz.php" name="form1"><br>
...
?>
  <table style="text-align: left; width: 50%;" align="center" border="1" cellpadding="2" cellspacing="2">
    <tbody>
      <tr>
        <td colspan="2" rowspan="1">Cadastro de usuario</td>
      </tr>
      <tr>
        <td>nome:</td>
      ...
      <tr>
        <td><a href="index.php"  target="_self">Inicio</a></td><form action="armaz.php" method="POST"  name="f2"><!-- form de envio ao voltar  -->
